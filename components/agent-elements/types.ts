...
/** Loose shape for dynamic tool parts from UI messages / AI SDK */
export type AgentToolPart = {
  ...
  result?: unknown;
  args?: unknown;
  /** Optional provider metadata (e.g. elapsed timing) */
...
export type AgentChatProps = {
  ...
  /** When true, the composer is visible but sends are blocked (e.g. waiting for RAG index). */
  inputDisabled?: boolean;
  /** Overrides the default "Send a message…" placeholder on the input. */
