    ...
    <div className={cn("flex flex-col items-end gap-1", className)}>
      ...
      {text && (
        <div className="max-w-[calc(95%-40px)] ms-[70px]">
          <div className="px-3.5 py-1.5 text-[13px] transition-colors rounded-an-message bg-an-user-message-bg text-an-user-message-text">
            <p className="leading-[1.35] whitespace-pre-wrap wrap-break-word">
              {text}
            </p>
          </div>
        </div>
