...
import { getToolStatus, areToolPropsEqual, toolInputRecord } from "../utils/format-tool";
...
function formatMcpArgs(input: Record<string, unknown> | undefined): string {
...
export const McpTool = memo(function McpTool({
  ...
  const subtitle = useMemo(() => {
    ...
    return formatMcpArgs(toolInputRecord(part));
  }, [part]);
