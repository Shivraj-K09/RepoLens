...
import { areToolPropsEqual, getToolStatus, toolInputRecord } from "../utils/format-tool";
...
export const PlanTool = memo(function PlanTool({
  ...
  const input = toolInputRecord(part);
  ...
  const approveLabel = (input.approveLabel as string | undefined) ?? "Approve";
  const isAlreadyApproved =
    Boolean(input.approved) || isApproved;
