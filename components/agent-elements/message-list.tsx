...
export const MessageList = memo(function MessageList({
  ...
  useLayoutEffect(() => {
    ...
    queueMicrotask(() => {
      setShowAssistantBreathingSpace(show);
    });
  }, [lastMessageId, lastMessageRole, showPlanning]);
  ...
  return (
    <div
      ...
      className={cn(
        "an-message-list flex-1 min-h-0 overflow-y-auto scrollbar-hide",
        className,
      )}
    >
